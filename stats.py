...
def display_stats(agent, training_totals, testing_totals, history):
    ...
    test_epi = [num+1 for num in range(
        agent.training_trials-(window_size-1), total_trials)]
